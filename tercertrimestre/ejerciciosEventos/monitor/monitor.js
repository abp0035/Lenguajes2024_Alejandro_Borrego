...
zona.addEventListener("drop", () => registrar("El círculo fue soltado dentro del div de interacción"));

document.addEventListener("drop", e => {
  if (!zona.contains(e.target)) registrar("El círculo fue soltado fuera del div de interacción");
});
